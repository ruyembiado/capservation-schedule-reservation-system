        ...
        <div class="card-body p-4">
            <form class="row g-3 needs-validation" action="{{ route('auth.register') }}" method="POST">
                ...
                <div class="d-flex align-items-start justify-content-center gap-5">
                    <input type="hidden" name="user_type" value="panelist">
                    <div class="col-6">
                        <!-- Email -->
    ...
    @enderror
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <select name="position" id="position"
                                ...
                                {{-- <option value="BSIT Course Instructor"
                                    {{ old('position') == 'BSIT Course Instructor' ? 'selected' : '' }}>BSIT Course
                                    Instructor</option>
                                <option value="BSCS Course Instructor"
                                    {{ old('position') == 'BSCS Course Instructor' ? 'selected' : '' }}>BSCS Course
                                    Instructor</option>
                                <option value="BSIS Course Instructor"
                                    {{ old('position') == 'BSIS Course Instructor' ? 'selected' : '' }}>BSIS Course
                                    Instructor</option> --}}
                                <option value="Panelists" {{ old('position') == 'Panelists' ? 'selected' : '' }}>Panelist
                                </option>
                            </select>
                            @error('position')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
