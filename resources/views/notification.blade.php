            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="notificationTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="system-alert-tab" data-bs-toggle="tab" href="#system-alert"
                            role="tab" aria-controls="system-alert" aria-selected="true">System Alerts</a>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="custom-reminder-tab" data-bs-toggle="tab" href="#custom-reminder"
                            role="tab" aria-controls="custom-reminder" aria-selected="false">Custom Reminders</a>
                    </li>
                    @if (auth()->user()->user_type == 'admin')
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="custom-reminder-tab" data-bs-toggle="tab" href="#create-reminder"
                                role="tab" aria-controls="create-reminder" aria-selected="false">Create Custom
                                Reminder</a>
                        </li>
                    @endif
                </ul>
                ...
                <div class="tab-content" id="notificationTabsContent">
                    <!-- System Alerts Tab -->
                    <div class="tab-pane fade show active" id="system-alert" role="tabpanel"
                        aria-labelledby="system-alert-tab">
                                ...
                                <tbody>
                                    @foreach ($notifications->where('notification_type', 'update_status') as $notification)
                                        ...
                                        <tr>
                                            <td class="{{ $highlightClass }}">{{ $loop->iteration }}</td>
                                            <td class="{{ $highlightClass }}">{{ $notification->notification_title }}</td>
                                            <td class="{{ $highlightClass }}">{{ $notification->notification_message }}
                                            </td>
                                            <td class="{{ $highlightClass }}">
                                                {{ \Carbon\Carbon::parse($notification->created_at)->format('Y-m-d h:i:s A') }}
                                            </td>
                    ...
                    <div class="tab-pane fade" id="custom-reminder" role="tabpanel"
                        aria-labelledby="custom-reminder-tab">
                        <div class="table-responsive mt-3">
                    ...
                    <div class="tab-pane fade" id="create-reminder" role="tabpanel"
                        aria-labelledby="custom-reminders-tab">
                        <form action="{{ route('custom.reminder') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title_status" id="title_status" class="form-control"
                                    required>
                                @error('title_status')
